...
//set to '0' if your host does not manage url rewriting properly and if the links between chapters do not work. In that case, replace the contents of the file .htaccess by the contents of "htaccess_pour_free-fr" if your site is hosted by Free.fr, or try to delete that file.
//passer à '0' si votre hébergeur ne gère pas convenablement la réécriture d'url et que les liens entre les chapitres ne fonctionnent pas. Dans ce cas, remplacez le fichier .htaccess par "htaccess_pour_free-fr" si vous êtes hébergé chez Free.fr, ou essayez de supprimer ce fichier.
$UrlRewriting = '1';
